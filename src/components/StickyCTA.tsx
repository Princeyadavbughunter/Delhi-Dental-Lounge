...
export default function StickyCTA({ isVisible, onBookAppointment }: StickyCtaProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-brandBlue text-white p-4 z-50 transition-transform duration-300">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          <a href="tel:+917838831325" className="bg-brandBlue text-white px-4 py-2 rounded-lg font-bold text-sm">
            CALL NOW ☏
          </a>
        </div>
      </div>
